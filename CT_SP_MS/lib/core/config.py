...
config.WLML.FRAME_MODULE_2 = edict()
config.WLML.FRAME_MODULE_2.NAME = ''
config.WLML.FRAME_MODULE_2.PARAMS = None

config.WLML.FRAME_MODULE_3 = edict()
config.WLML.FRAME_MODULE_3.NAME = ''
config.WLML.FRAME_MODULE_3.PARAMS = None

config.WLML.VLBERT_MODULE_2 = edict()
config.WLML.VLBERT_MODULE_2.NAME = ''
config.WLML.VLBERT_MODULE_2.PARAMS = None
config.WLML.VLBERT_MODULE_3 = edict()
config.WLML.VLBERT_MODULE_3.NAME = ''
config.WLML.VLBERT_MODULE_3.PARAMS = None
config.WLML.PRED_INPUT_SIZE = 512
config.WLML.PRE_SMOOTH = False

# common params for NETWORK
config.MODEL = edict()
config.MODEL.NAME = ''
config.MODEL.CHECKPOINT = '' # The checkpoint for the best performance
config.MODEL.CHECKPOINT_2 = ''
config.MODEL.CHECKPOINT_3 = ''
