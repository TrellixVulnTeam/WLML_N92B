...
if __name__ == '__main__':
    ...
    def network(sample):
        ...
        sorted_times = None if model.training else get_proposal_results(video_att*video_score, duration)
    ...
    def get_proposal_results(video_att, durations):
        ...
        scores = savgol_filter(video_att.cpu().detach().numpy(), config.TEST.SAVGOL_K, 1, mode= 'nearest')
